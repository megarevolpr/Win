...
*	NOTE    :
*=================================================================================*/
#include "keyboard_hex.h"
#include "ui_keyboard_hex.h"
...
Keyboard_Hex::~Keyboard_Hex()
{
    delete ui;
}

bool Keyboard_Hex::eventFilter(QObject *obj, QEvent *event)
{
...
//***********************按键*****************************//
void Keyboard_Hex::on_num1Button_clicked()       //1
{
    if(flag_key == First)
    {
...
void Keyboard_Hex::on_num2Button_clicked()       //2
{
    if(flag_key == First)
    {
        ui->lineEdit->setCursorPosition(0);
...
void Keyboard_Hex::on_num3Button_clicked()       //3
{
    if(flag_key == First)
    {
        ui->lineEdit->setCursorPosition(0);
...
void Keyboard_Hex::on_num4Button_clicked()       //4
{
    if(flag_key == First)
    {
        ui->lineEdit->setCursorPosition(0);
...
void Keyboard_Hex::on_num5Button_clicked()       //5
{
    if(flag_key == First)
    {
        ui->lineEdit->setCursorPosition(0);
...
void Keyboard_Hex::on_num6Button_clicked()       //6
{
    if(flag_key == First)
    {
        ui->lineEdit->setCursorPosition(0);
...
void Keyboard_Hex::on_num7Button_clicked()       //7
{
    if(flag_key == First)
    {
        ui->lineEdit->setCursorPosition(0);
...
void Keyboard_Hex::on_num8Button_clicked()       //8
{
    if(flag_key == First)
    {
        ui->lineEdit->setCursorPosition(0);
...
void Keyboard_Hex::on_num9Button_clicked()       //9
{
    if(flag_key == First)
    {
        ui->lineEdit->setCursorPosition(0);
...
void Keyboard_Hex::on_dotButton_clicked()        //.
{
    if(flag_key == First)
    {
        ui->lineEdit->setCursorPosition(0);
...
void Keyboard_Hex::on_cancelButton_2_clicked() // :
{
    if(flag_key == First)
    {
        ui->lineEdit->setCursorPosition(0);
...
void Keyboard_Hex::on_num0Button_clicked()       //0
{
    if(flag_key == First)
    {
        ui->lineEdit->setCursorPosition(0);
...
void Keyboard_Hex::on_numAButton_clicked()   //     A
{
    if(flag_key == First)
    {
        ui->lineEdit->setCursorPosition(0);
...
void Keyboard_Hex::on_numBButton_clicked()//     B
{
    if(flag_key == First)
    {
        ui->lineEdit->setCursorPosition(0);
...
void Keyboard_Hex::on_numCButton_clicked()// c
{
    if(flag_key == First)
    {
        ui->lineEdit->setCursorPosition(0);
...
void Keyboard_Hex::on_numDButton_clicked()//D
{
    if(flag_key == First)
    {
        ui->lineEdit->setCursorPosition(0);
...
void Keyboard_Hex::on_numEButton_clicked()//E
{
    if(flag_key == First)
    {
        ui->lineEdit->setCursorPosition(0);
...
void Keyboard_Hex::on_numFButton_clicked()//F
{
    if(flag_key == First)
    {
        ui->lineEdit->setCursorPosition(0);
...
void Keyboard_Hex::on_signButton_clicked()       //+/-
{
    if(flag_key == First)
    {
        ui->lineEdit->setCursorPosition(0);
...
//void Keyboard_Hex::on_leftButton_clicked()       //left
//{
//    int idx = ui->lineEdit->cursorPosition();
//    if(idx == 0)
//    {
...
//void Keyboard_Hex::on_rightButton_clicked()      //right
//{
//    int idx = ui->lineEdit->cursorPosition();
...
void Keyboard_Hex::on_backspaceButton_clicked()      //backspace
{
    flag_key = other;
    int idx = ui->lineEdit->cursorPosition();
    if(idx == 0)
...
void Keyboard_Hex::on_cancelButton_clicked()     //cancel
{
    ui->lineEdit->clear();
    this->close();
    valid = false;
...
void Keyboard_Hex::on_okButton_clicked()         //ok
{
    this->close();
    valid = true;
    flag_key = First;
...
void Keyboard_Hex::setText(QString str)      //设置文本内容
{
    strContent = str;
    ui->lineEdit->setText(strContent);
    ui->lineEdit->setFocus();
...
QString Keyboard_Hex::getText()              //获取内容
{
    return strContent;
}
