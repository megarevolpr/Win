...
2023-09-27  17:28:00.121  CAN 2: Rx  Len=8  ID=9f000300 40 1f a0 0f e8 03 e8 03</source>
        <translation>2023-09-27  17:27:56.201  CAN 2: Tx  Len=8  ID=9f000100 00 00 00 00 00 00 00 00
2023-09-27  17:27:56.302  CAN 2: Rx  Len=8  ID=9f000301 0d 00 64 00 70 17 e8 03
2023-09-27  17:27:57.105  CAN 2: Rx  Len=8  ID=9f000300 40 1f a0 0f e8 03 e8 03
2023-09-27  17:27:57.206  CAN 2: Tx  Len=8  ID=9f000100 00 00 00 00 00 00 00 00
2023-09-27  17:27:57.307  CAN 2: Rx  Len=8  ID=9f000301 0d 00 64 00 70 17 e8 03
...
2023-09-27  17:27:59.317  CAN 2: Rx  Len=8  ID=9f000301 0d 00 64 00 70 17 e8 03
2023-09-27  17:27:59.920  CAN 2: Rx  Len=8  ID=9f000304 40 1f a0 0f 00 00 00 00
2023-09-27  17:28:00.121  CAN 2: Rx  Len=8  ID=9f000300 40 1f a0 0f e8 03 e8 03</translation>
    </message>
    <message>
...
Please connect a UBS flash drive!</source>
        <translation>报文数据将会写入U盘的根目录下的“PortData.txt”文件。
请连接U盘！</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>强充有两种状态：使能，禁止。使能时开启强充，禁止时停止强充。</translation>
    </message>
    <message>
        ...
        <translation>强充停止电压：单体电池最高电压高于该值时，退出强充并返回强充前的状态。</translation>
    </message>
    <message>
...
(Note: Due to the fact that CAN and Ethernet both have only one port, the battery communication mode and EMS communication mode cannot be selected as &quot;CAN&quot; or &quot;Ethernet&quot; simultaneously.)</source>
        <translation>电池通信方式：无、RS485、CAN、以太网、EMS调度。
EMS调度：当电池数据从EMS上传时(EMS_CAN)选择此项。如果使用MEGA标准CAN_BMS_EMS协议，EMS_CAN协议需选择“标准”。
(备注:由于CAN端口和以太网都只有一个端口，因此电池通讯方式和EMS通讯方式不可同时选&quot;CAN&quot;或“以太网&quot;。)</translation>
    ...
    <message>
        ...
        <translation>EMS CAN 协议：无，标准(CAN_BMS_EMS协议)，东方氢能。</translation>
    </message>
    <message>
...
This is the dynamic capacity expansion function done by DSP: the capacity of the power grid port is set by constant power, the positive value is the grid capacity attribute, and the negative value is the load capacity attribute, which can be dispatched by EMS.</source>
        <translation>电网扩容：使能、禁止。
这是DSP做的电网动态扩容功能：电网端口的容量由恒功率进行设置，正值为上网容量属性，负值为负载容量属性，可由EMS调度。</translation>
    </message>
    <message>
...
For example, the function item of DI3 will select &quot;Access Control&quot; and will prompt an access control alarm when the signal is triggered.Similarly, the function item of DI3 will select &quot;Smoke&quot; and will prompt a smoke alarm when the signal is triggered.</source>
        <translation>干接点功能项为可自选。
可选功能项：EPO关机、NC关机、门禁、满功率信号、烟雾、温度、水浸、BMS告警、ATS信号。
例：DI3的功能项选择“门禁”，当触发该信号时将提示门禁告警。同理，DI3的功能项选择“烟雾”，当触发该信号时将提示烟雾告警。</translation>
    </message>
    <message>
...
(for example, Modbus protocol has a 1050 register (output line voltage AB), when the Modbus offset address is 3000, the register address used to read its value is 4050.)</source>
        <translation type="vanished">Modbus偏移地址：寄存器读取或写入地址的偏移量，默认值为0。
(例：Modbus协议存在1050寄存器(输出线电压AB)，当Modbus偏移地址为3000时，用于读取其值的寄存器地址为4050。)</translation>
    </message>
    <message>
...
远程:EMS可以进行读写控制。</translation>
    ...
    <message>
        ...
        <translation>强充开启电压：单体电池最低电压低于该值时，交流侧将以机器容量的百分之十的功率给电池充电。</translation>
    </message>
    <message>
        <source>Force Charge stop: When the cell voltage drops exceeds this value, the converter exits the forced charging and returns to the state before forced charging.</source>
        <translation type="vanished">强充停止电压：单体电池最高电压高于该值时，退出强制充电并返回强制充电前的状态。</translation>
    </message>
    <message>
...
Select AUTO to automatically detect the battery manufacturer protocol.</source>
        <translation>电池协议:根据选择的电池协议解析BMS发送的报文。目前支持选择的电池厂家协议为:迈格, 力神, 鹏辉, 高特, 协能, 蓝锂, 深澜, 派能, 宁德时代, 索英, 欣旺达, 库博, 高特V2, 拓高, PCS团标, 沃博源, 科工, 里德, 派能L, 未蓝, 沃太能源, 拓普, 捷辉, 金锂动, 先控, 法罗, BMS团标, 行一, 华塑, 力高, 弗迪, Freedom, 宁德时代_RTU。
...
Select AUTO to automatically detect the battery manufacturer protocol.</source>
        <translation type="vanished">电池协议:根据选择的电池协议解析BMS发送的报文。目前支持选择的电池厂家协议为:迈格, 力神, 鹏辉, 高特, 协能, 蓝锂, 深澜, 派能, 宁德时代, 索英, 欣旺达, 库博, 高特V2, 拓高, 团标, 沃博源, 科工, 里德, 派能L, 未蓝, 沃太能源, 拓普, 捷辉, 金锂动, 法罗.
选择AUTO时将自动判断电池厂家协议。</translation>
    </message>
    <message>
...
Countercurrent allows converter current to flow into the grid, while Non Countercurrent prevents converter current from flowing into the grid.</source>
        <translation type="vanished">变流器防逆流:可逆流、不可逆流;可逆流即变流器电流允许流向电网，不可逆流即变流器电流禁止流向电。</translation>
    </message>
    <message>
        <location filename="../win.cpp" line="5900"/>
...
adjustable</source>
    ...
    <message>
        ...
        <translation type="vanished">输出无功方式：默认不可调节，可供选择为功率因数、无功功率、不可调节。</translation>
    </message>
    <message>
        <source>Non
...
禁止：当干接点检测到与指定的常开/常闭状态不一致时，不执行任何动作。</translation>
    ...
    <message>
        <source>The dry contact function is optional.
For example, the function item of DI3 will select &quot;Access Control&quot; and will prompt an access control alarm when the signal is triggered.Similarly, the function item of DI3 will select &quot;Smoke&quot; and will prompt a smoke alarm when the signal is triggered.</source>
        <translation type="vanished">干接点功能项为可自选。
例：DI3的功能项选择“门禁”，当触发该信号时将提示门禁告警。同理，DI3的功能项选择“烟雾”，当触发该信号时将提示烟雾告警。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>输入干接点1功能描述</translation>
    </message>
    <message>
        <location filename="../win.cpp" line="5419"/>
        <source>DI_2_Function</source>
        <translation>输入干接点2功能描述</translation>
    </message>
    <message>
        <location filename="../win.cpp" line="5427"/>
        <source>DI_3_Function</source>
        <translation>输入干接点3功能描述</translation>
    </message>
    <message>
        <location filename="../win.cpp" line="5435"/>
        <source>DI_4_Function</source>
        <translation>输入干接点4功能描述</translation>
    </message>
    <message>
        <location filename="../win.cpp" line="5443"/>
        <source>DI_5_Function</source>
        <translation>输入干接点5功能描述</translation>
    </message>
    <message>
        <location filename="../win.cpp" line="5451"/>
        <source>DI_6_Function</source>
        <translation>输入干接点6功能描述</translation>
    </message>
    <message>
...
Backup</source>
    ...
    <message>
        ...
        <translation type="vanished">这是自动获取IP，暂不支持。</translation>
    </message>
    <message>
        <source>dhcp</source>
...
fault</source>
    ...
    <message>
        ...
        <translation type="vanished">电池通信方式：无、RS485、CAN、以太网。(备注:由于CAN端口和以太网都只有一个端口，因此电池通讯方式和EMS通讯方式不可同时选&quot;CAN&quot;或“以太网&quot;。)</translation>
    </message>
    <message>
...
选择AUTO时将自动判断电池厂家协议。</translation>
    ...
    <message>
        ...
        <translation>输出无功方式：默认不可调节，可供选择为不可调节、功率因数、无功功率。</translation>
    </message>
    <message>
        <location filename="../win.cpp" line="5143"/>
        <source>Non
Countercurrent</source>
    ...
    <message>
        <source>Converter Anti-Reverse Flow: Countercurrent, Non Countercurrent; Countercurrent allows converter current to flow into the grid, while Non Countercurrent prevents converter current from flowing into the grid.</source>
        <translation type="vanished">变流器防逆流:可逆流、不可逆流;可逆流即变流器电流允许流向电网，不可逆流即变流器电流禁止流向电。</translation>
    </message>
    <message>
        <location filename="../win.cpp" line="5492"/>
...
(注:本设置仅在系统防逆流模式生效，用于控制电网入口的功率容差)。</translation>
    ...
    <message>
        ...
        <source>Modbus Offset Address: The offset of the register read or write address, the default value is 0.
(For example, Modbus protocol has a 1050 register (output line voltage AB), when the Modbus offset address is 3000, the register address used to read its value is 4050.)</source>
        <translation>Modbus偏移地址：寄存器读取或写入地址的偏移量，默认值为0。
(例：Modbus协议存在1050寄存器(输出线电压AB)，当Modbus偏移地址为3000时，用于读取其值的寄存器地址为4050。)</translation>
    </message>
    <message>
